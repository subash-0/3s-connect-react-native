...
const PostComposer = () => {
  ...
  const { user } = useUser();
  return (
    <View className="border-b-2 border-gray-200 bg-white p-2">
      ...
      {selectedImage && (
        <View className="mt-3 ml-5">
          <View className="relative">
            ...
            />
            <TouchableOpacity
              className="absolute top-2 right-2 w-8 h-8 bg-black/60 rounded-full justify-center items-center flex"
              onPress={removeImage}
            >
